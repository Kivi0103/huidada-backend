...
import com.kivi.huidada.model.dto.app.AppQueryRequest;
import com.kivi.huidada.model.entity.App;
import com.kivi.huidada.model.entity.User;
import com.kivi.huidada.model.enums.AppTypeEnum;
import com.kivi.huidada.model.enums.ReviewStatusEnum;
import com.kivi.huidada.model.enums.ScoringStrategyEnum;
import com.kivi.huidada.model.vo.AppVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(scoringStrategyEnum ==null, ErrorCode.PARAMS_ERROR, "打分策略非法");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
        if (ObjectUtil.isNotEmpty(appName)) {
            ThrowUtils.throwIf(appName.length() > 80, ErrorCode.PARAMS_ERROR, "应用名称长度要小于80个字符");
        }
